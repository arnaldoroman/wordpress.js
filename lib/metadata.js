...
function Metadata(attributes, terms, archive, multisite) {
    ...
    Object.defineProperty(this, 'multisite', {
        value: multisite || {}
      , enumerable: false
    });
    ...
    Object.defineProperty(this, 'term_slugs', {
        value: slugs
      , enumerable: false
    });
}
...
Metadata.prototype.syncTerms = function (current) {
    ...
    for (id in previous) {
        if (!(id in current)) {
            ...
            delete this.term_slugs[previous[id].slug];
            delete previous[id];
        } else {
            ...
            if (current[id].slug !== previous[id].slug) {
                ...
                this.term_slugs[previous[id].slug] = previous[id];
            }
    ...
    added.forEach(function (term) {
        ...
        self.term_slugs[term.slug] = term;
    });
    for (id in previous) {
