...
REPLACE INTO `wp_2_postmeta` VALUES (1,1,'frontpage-post-type','Video'),(2,1,'_thumbnail_id','100001'),(3,1,'orientation','top'),(4,1,'original_title','Bacon ipsum'),(7,2,'frontpage-post-type','Quick'),(8,2,'_thumbnail_id','100001'),(9,2,'orientation','top'),(10,2,'original_title','Ham andouille speck'),(13,3,'frontpage-post-type','Video'),(14,3,'_thumbnail_id','100001'),(15,3,'orientation','top'),(16,3,'original_title','Dolor sit amet meatball'),(17,100001,'crop','foobar'),(18,100001,'_wp_attachment_metadata','a:2:{s:5:\"width\";s:3:\"880\";s:7:\"height\";s:3:\"587\";}');
...
REPLACE INTO `wp_users` VALUES (1,'foo','<pwhash>','foo','foo@example.com','',NOW(),'',0,'Foo',0,0),(2,'bar','<pwhash>','bar','bar@example.com','',NOW(),'',0,'Bar',0,0);
